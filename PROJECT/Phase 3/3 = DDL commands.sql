...
-- _______ADD column in member table
ALTER TABLE Member
ADD JoinDate DATE;

-- _______Drop feedback table table
DROP TABLE Feedback;

-- _______ADD column in Trainer table
ALTER TABLE Trainer
ADD Location VARCHAR(100);

-- _______Drop column in Equipment table
ALTER TABLE Equipment
DROP COLUMN Conditions;

-- _______Change name supplier to Vendor
ALTER TABLE Supplier RENAME TO Vendor;

-- _______ADD column in Payment table
ALTER TABLE Payment
ADD FeePaid BOOLEAN;

-- _______Change name of a table
ALTER TABLE Staff 
RENAME TO Employees;

-- _______Drop a colomn in membership table
